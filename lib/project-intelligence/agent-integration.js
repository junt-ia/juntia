...
function buildPointerContent(profile, runtimeName) {
  return [
    ...
    'about this project.',
    '',
    'If asked to analyze or interpret this project for Juntia, follow `.juntia/agent-instructions.md` —',
    'it explains the expected response format, how to cite evidence, and where to write your proposal',
    'so Juntia can validate it and ask a human to confirm it.',
    '',
