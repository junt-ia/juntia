...
function buildArgs(requestText, model) {
  return [
...
function interpret(requestText, { timeoutMs = DEFAULT_TIMEOUT_MS, model = DEFAULT_MODEL } = {}) {
  return new Promise((resolve) => {
    const bin = resolveClaudeBinary();
    const args = buildArgs(requestText, model);
