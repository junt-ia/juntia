...
// classified Legacy Reasoning Layer since Phase 15A, which also found this
// file bundles two genuinely different concerns — free-text impact-category
// detection (`IMPACT_CUES`, duplicated reasoning) and risk/impact-tier
// classification (`impactLevelFromCategories`, `ALWAYS_CONFIRM_CATEGORIES`,
// proportional-governance logic). Phase 15C's own `lib/governance/
// governance-levels.js` (LIGHT/STANDARD/STRICT) is the direct, named
// successor to the second half — grounded in this file's own tier tables,
// per Phase 15A §7 — but does not read from or call this module; the levels
// were recognized, not extracted as code. This file is untouched, unremoved,
// unwired. See phases/15c-workflow-routing.md.
