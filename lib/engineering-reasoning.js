...
// classified Legacy Reasoning Layer since Phase 15A. This module's job —
// assembling an implementation plan (objective, scope, steps, validation
// strategy) — is exactly the kind of "how to build it" reasoning Phase
// 15C's own governing principle keeps out of Juntia entirely ("Juntia no
// implementa código"); nothing in the new Workflow Routing Engine attempts
// to replace it. Untouched, unremoved, unwired. See
